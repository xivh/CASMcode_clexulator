...
latex_documents = [
    (
        master_doc,
        "libcasm-clexulator.tex",
        "libcasm-clexulator Documentation",
        "CASM Developers",
        "manual",
    ),
]
...
man_pages = [
    (master_doc, "libcasm-clexulator", "libcasm-clexulator Documentation", [author], 1)
]
